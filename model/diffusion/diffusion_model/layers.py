...
def get_act(config):
  ...
  if config['diffusion_model']['nonlinearity'].lower() == 'elu':
    return nn.ELU()
  elif config['diffusion_model']['nonlinearity'].lower() == 'relu':
    return nn.ReLU()
  elif config['diffusion_model']['nonlinearity'].lower() == 'lrelu':
    return nn.LeakyReLU(negative_slope=0.2)
  elif config['diffusion_model']['nonlinearity'].lower() == 'swish':
    return nn.SiLU()
  else:
